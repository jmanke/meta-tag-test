...
"undefined"!=typeof document&&(r.p=(n=document.querySelectorAll("script"))[n.length-1].src.replace(/\/[^/]*$/,"/")),e.exports=(i=_eai_d,o=_eai_r,window.emberAutoImportDynamic=function(e){return 1===arguments.length?o("_eai_dyn_"+e):o("_eai_dynt_"+e)(Array.prototype.slice.call(arguments,1))},void i("taginsert",[],(function(){return r(3)})))},function(e,t,r){"use strict"
r.r(t),"function"!=typeof Object.assign&&Object.defineProperty(Object,"assign",{value:function(e,t){if(null==e)throw new TypeError("Cannot convert undefined or null to object")
for(var r=Object(e),n=1;n<arguments.length;n++){var i=arguments[n]
if(null!=i)for(var o in i)Object.prototype.hasOwnProperty.call(i,o)&&(r[o]=i[o])}return r},writable:!0,configurable:!0})
var n={w3c:{title:"title",description:"snippet",keywords:"typeKeywords",image_src:"thumbnail"},twitter:{title:"title",description:"snippet",image:"thumbnail"},og:{title:"title",description:"snippet",url:"itemUrl",image:"thumbnail"}}
function i(e){if(e){if(!window.URL||"function"!=typeof window.URL)return function(e){var t=e.split("?")
if(1===t.length||0===t[1].length)return e
var r=t[1].split("#")
r[1]&&r[1].length?(t[1]=r[0],r=r[1]):r=""
var n=t[1].split("&").map((function(e){var t=e.split("=")
return"token"==t[0]?[]:t})).reduce((function(e,t){return e.length&&(e+="&"),t.length&&(e+=t.join("=")),e}),""),i=t[0]
return n&&n.length&&(i+="?"+n),r&&r.length&&(i+="#"+r),i}(e)
try{var t=new URL(e)
return t.searchParams.has("token")&&t.searchParams.delete("token"),t.toString()}catch(t){return console.log("can not parse ".concat(e," into a valid URL")),""}}}function o(e){var t=document.createElement("meta")
for(var r in e)if(e.hasOwnProperty(r)){var n=e[r]
t.setAttribute(r,n)}document.head.appendChild(t)}t.default=function(e){var t=e.profiles,r=void 0===t?"w3c,twitter,og":t,a=e.mapping,s=e.item,u=e.imageSrc,l=e.noindex
if(s&&l&&"function"==typeof l&&l(s))o({name:"robots",content:"noindex"})
else{r=r.toLowerCase().split(",").map((function(e){return e.trim()}))
var c=function(e){return Object.keys(e).reduce((function(t,r){return t[r]=Object.assign({},e[r]),t}),{})}(n)
if(u&&(c.w3c.image_src=u,c.twitter.image=u,c.og.image=u),a)for(var d in a)if(a.hasOwnProperty(d)){var f=a[d]
c[d]?Object.assign(c[d],f):c[d]=f}r.forEach((function(e){"w3c"==e?function(e,t){if(["title","description","keywords"].forEach((function(r){var n=t[r],i=e[n]
Array.isArray(i)&&(i=i.join(",")),void 0!==i&&o({name:r,content:i})})),null!=e[t.image_src]){var r=i(e[t.image_src])
if(""!=r){var n=document.createElement("link")
n.setAttribute("rel","image_src"),n.setAttribute("href",r),document.head.appendChild(n)}}}(s,c[e]):"twitter"==e?function(e,t){for(var r in o({name:"twitter:card",content:"summary"}),o({name:"twitter:site",content:"@arcgisonline"}),t)if(t.hasOwnProperty(r)){var n=t[r],a="image"==r?i(e[n]):e[n]
Array.isArray(a)&&(a=a.join(",")),void 0!==a&&""!==a&&o({name:"twitter:".concat(r),content:a})}}(s,c[e]):"og"==e?function(e,t){for(var r in t)if(t.hasOwnProperty(r)){var n=t[r],a="image"==r?i(e[n]):e[n]
Array.isArray(a)&&(a=a.join(",")),void 0!==a&&""!==a&&o({property:"og:".concat(r),content:a})}}(s,c[e]):c[e]&&c[e].insert&&"function"==typeof c[e].insert&&c[e].insert(s,c[e])}))}}}])
